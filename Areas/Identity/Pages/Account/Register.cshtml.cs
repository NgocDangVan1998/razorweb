...
namespace RazorPageIdentity.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    //Phát sinh ra url có cấu trúc dạng : https://localhost:5001/confirm-email?userId=?&code=?&returnUrl=?
                    ...
                    await _emailSender.SendEmailAsync(Input.Email, "Xác nhận địa chỉ Email",
                        $"Bạn đã đăng ký tài khoản trên Razor Web, hãy <a href='{HtmlEncoder.Default.Encode(callbackUrl)}'>Bấm vào đây</a> để kích hoạt tài khoản.");
                    ...
                    {
                        //isPersistent : Có lưu vào cookie để lần sau tự động đăng nhập
